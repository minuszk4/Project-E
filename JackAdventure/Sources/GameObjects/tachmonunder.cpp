...
{
	m_HitBox = new HitBox(sf::Vector2i(58, 59));
	...
	m_runAni = new Animation(*DATA->getTexture("tachmon/mounder"), sf::Vector2i(1, 1), 0.1f);
	m_deathAni = new Animation(*DATA->getTexture("tachmon/mounder"), sf::Vector2i(1, 1), 0.1f);
